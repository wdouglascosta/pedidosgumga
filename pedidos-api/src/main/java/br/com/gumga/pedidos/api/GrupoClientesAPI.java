...
@RestController
@RequestMapping("/api/grupoclientes")
@Transactional
public class GrupoClientesAPI extends GumgaAPI<GrupoClientes, Long> {


@Autowired  
public GrupoClientesAPI(GumgaService<GrupoClientes, Long> service) {
    super(service);
}
