define([], function() {
  ...
  ModalItemPedidoController.$inject = ['$scope', 'gumgaController', '$uibModal', '$uibModalInstance', 'entity','ProdutoService'];

  function ModalItemPedidoController($scope, gumgaController, $uibModal, $uibModalInstance, entity,ProdutoService) {
