package br.com.gumga.pedidos.boot;
...
@SpringBootApplication(scanBasePackages = {"br.com.gumga.pedidos.boot.components",
                                           "br.com.gumga.pedidos.application.service",
                                           "io.gumga",
                                           "br.com.gumga.pedidos.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"br.com.gumga.pedidos.application.repository", "io.gumga"})
...
public class Application {
    ...
    public DataSource dataSource() {
        ...
        config.addDataSourceProperty("url", getProperties().getProperty("dataSource.url", "jdbc:h2:mem:pedidos;MVCC=true"));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "br.com.gumga.pedidos.domain.model");
